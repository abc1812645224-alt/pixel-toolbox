...
package com.example.pixeltoolbox.data
...
class AppPreferences(context: Context) {
    ...
    object DefaultsValue {
        ...
        const val CALL_RECORDER_ENABLED = false
        ...
        // --- File Naming ---
        const val FILE_NAME_TEMPLATE = "{date}_{direction}_{phone_number}_{sequence}"
    ...
    enum class Key(val id: String) {
        ...
        CALL_RECORDER_ENABLED("call_recorder_enabled"),
    ...
    /** Checks if the call recorder master switch is enabled. */
    fun isCallRecorderEnabled() = getBoolean(Key.CALL_RECORDER_ENABLED, DefaultsValue.CALL_RECORDER_ENABLED)

    /** Sets whether the call recorder master switch is enabled. */
    fun setCallRecorderEnabled(enabled: Boolean) = setBoolean(Key.CALL_RECORDER_ENABLED, enabled)
