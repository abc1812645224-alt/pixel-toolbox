...
package com.example.pixeltoolbox.integrations.scrcpy

import android.media.MediaFormat
import android.media.MediaMuxer
import com.example.pixeltoolbox.R
import com.example.pixeltoolbox.services.recording.RecordingForegroundService
...
enum class ScrcpyAudioCodec(
     ...
     * at very low bit rates. Default 64 kbps for clearer audio.
     ...
     * voice quality. Default 64 kbps for clearer audio. Recordings are saved in an MPEG-4 (M4A) container.
     *
