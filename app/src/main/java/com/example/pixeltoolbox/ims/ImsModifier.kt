    ...
    fun main(args: Array<String>) {
        ...
        try {
            ...
            if (groupUiEnhancement) {
                ...
                b.putIntArray(CarrierConfigManager.KEY_5G_NR_SSRSRQ_THRESHOLDS_INT_ARRAY, intArrayOf(-16, -12, -8, -4))
                b.putIntArray(CarrierConfigManager.KEY_5G_NR_SSSINR_THRESHOLDS_INT_ARRAY, intArrayOf(-3, 3, 9, 15))
                b.putInt("nr_advanced_threshold_bandwidth_khz_int", 110000)
