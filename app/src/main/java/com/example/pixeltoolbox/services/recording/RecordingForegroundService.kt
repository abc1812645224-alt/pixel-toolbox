...
class RecordingForegroundService : Service() {
    companion object {
        ...
        const val ACTION_START_RECORDING = "com.example.pixeltoolbox.START_RECORDING"

        /** Intent action sent to this service to initialize and prepare the recording session in standby mode. */
        const val ACTION_STANDBY = "com.example.pixeltoolbox.STANDBY"

        /** Intent action sent to this service to stop the current recording session and kill the service. */
        const val ACTION_STOP_RECORDING = "com.example.pixeltoolbox.STOP_RECORDING"
        ...
        const val ACTION_PAUSE_RECORDING = "com.example.pixeltoolbox.PAUSE_RECORDING"

        /** Intent action sent to this service to resume the current recording. */
        const val ACTION_RESUME_RECORDING = "com.example.pixeltoolbox.RESUME_RECORDING"


        /**
         * Intent action sent by the standby notification's "Record" button.
         */
        const val ACTION_MANUAL_START = "com.example.pixeltoolbox.MANUAL_START_RECORDING"

        /** Intent action sent to this service when the user dismisses the notification (Android 14+). */
        const val ACTION_NOTIFICATION_DISMISSED = "com.example.pixeltoolbox.SERVICE_NOTIFICATION_DISMISSED"
    }
